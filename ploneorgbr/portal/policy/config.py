...
PRODUCTS=[
         ...
         ('collective.recaptcha',0,1,1,'collective.recaptcha:default',1),
         ...
         ('ploneorg.kudobounty',0,1,1,'ploneorg.kudobounty:default',1),
         ('ploneorg.kudobounty',0,0,0,'ploneorg.kudobounty:portlets',0),
         ('sc.social.like',0,1,1,'sc.social.like:default',1),
         ('sc.social.like',0,1,0,'sc.social.like:uninstall',0),
         ('Products.Doormat',0,1,1,'Products.Doormat:default',1),
         ('Products.Doormat',0,1,0,'Products.Doormat:uninstall',0),
         ('Products.Carousel',0,1,1,'Products.Carousel:default',1),
         ...
         #('Products.Poi',0,1,1,'Products.Doormat:default',1),
]
